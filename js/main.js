...
const MAP_DEFS = {
  ...
  'map-overview': {
    ...
    existing: [
      ...
      {c:[37.820,-96.871],e:'🏥',t:'Susan B. Allen Memorial Hospital',
        cur:'58-bed acute care hospital — El Dorado\'s only hospital, serving all of Butler County since 1949.',
      ...
      {c:[37.776,-96.808],e:'✈️',t:'El Dorado Airport — EQA (Existing)',
        cur:'Active general aviation airport with existing runway, fuel, and minimal hangar capacity.',
        imp:'Runway extension to 5,500 ft, ILS instrument approach, 20 new T-hangars. 90% FAA-funded.',
  ...
  'map-lake': {
    ...
    existing: [
      ...
      {c:[37.828,-96.814],e:'💧',t:'El Dorado Dam (Corps of Engineers)',
        cur:'Existing Corps of Engineers dam creating El Dorado Lake. Southern anchor of the lake corridor.',
        imp:'No change to dam structure. Improve public access road and parking at dam overlook.',
        sav:'Public land — no acquisition cost for overlook improvements.'},
    ...
    legend: {
      ...
      sections: [
        { head: '🏆 #1 Most-Visited State Park in Kansas', entries: [
          ...
          { type:'existing', label:'Shady Creek Marina (Existing)', sub:'Current boat rentals · KDWPT concession · Expanding in place' },
          { type:'existing', label:'El Dorado Dam (Corps of Engineers)', sub:'Creates 8,000-acre lake · 60 ft max depth · City water supply' },
        ]},
  ...
  'map-south': {
    ...
    existing: [
      {c:[37.776,-96.808],e:'✈️',t:'El Dorado Airport — EQA (Existing)',
        cur:'Active GA airport: existing runway (shorter), FBO, fuel, minimal hangar space.',
        imp:'Runway extension to 5,500 ft, ILS approach, 20 new T-hangars. 90% FAA-funded.',
  ...
  'map-surrounding-region': {
    ...
    existing: [
      ...
      {c:[37.6951,-97.3372],e:'✈️',t:'Wichita — Air Capital of the World',
        cur:'Pop. 400,000+ · Sedgwick County seat · Spirit AeroSystems (Boeing 2025), Textron Aviation (Cessna/Beechcraft), Bombardier (U.S. HQ since 2022, 1.3M sq ft) · 30,000+ aerospace jobs',
    ...
    legend: {
      ...
      sections: [
        ...
        { head: 'El Dorado\'s Regional Advantages', entries: [
          ...
          { type:'phase', color:'#4A90BF', num:'ROZ', label:'Butler County Rural Opportunity Zone', sub:'$15K student loan forgiveness + 5-yr state income tax exemption' },
        ]},
      ],
    },
  },
  ...
  'map-butler-county': {
    ...
    markers: [
      {c:[37.8500,-96.8000],col:'#4A90BF',e:'💧',t:'El Dorado Lake — City-Owned Water Supply',
        d:'8,000+ acre reservoir · 50+ billion gallons storage · 22M gal/day regional supply capacity · 50-year drought resilience. El Dorado holds unique ownership — only city-owned storage in a major Corps of Engineers reservoir.',
    ...
    legend: {
      ...
      sections: [
        ...
        { head: 'County-Scale Assets (El Dorado-Owned or Anchored)', entries: [
          { type:'dot', color:'#4A90BF', label:'El Dorado Lake — City-Owned', sub:'8,000 acres · #1 most-visited KS state park · 50B+ gallon water storage' },
          { type:'dot', color:'#2E6E35', label:'Butler Community College', sub:'2nd-largest CC in KS · 6,106 students · $46M annual county economic impact' },
